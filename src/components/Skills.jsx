...
const Skills = () => {
  ...
  const technologies = [
    ...
    { 
      name: 'HTML',
      icon: (
        <svg viewBox="0 0 256 361" width="100%" height="100%">
    ...
    { 
      ...
      icon: (
        <svg viewBox="0 0 256 361" width="100%" height="100%">
          ...
          <path d="M60.484 0h38.68v16.176H76.66v16.176h22.506v16.175H60.484V0zM106.901 0h38.681v14.066h-22.505v2.813h22.505v32.352h-38.68V35.298h22.505v-2.813h-22.505V0zM153.319 0H192v14.066h-22.505v2.813H192v32.352h-38.681V35.298h22.505v-2.813H153.32V0z" fill="#000"/>
    ...
    { 
      name: 'MongoDB',
      icon: (
        <svg viewBox="0 0 256 549" width="100%" height="100%">
          <path d="M175.622 61.108C152.612 33.807 132.797 6.078 128.749.32a1.03 1.03 0 0 0-1.492 0c-4.048 5.759-23.863 33.487-46.874 60.788-197.507 251.896 31.108 421.58 31.108 421.58l1.917 1.017v.427h1.019v-.427l1.898-1.017s228.616-169.684 31.108-421.58h.19Z" fill="#47A248"/>
          <path d="M131.495 502.287h-3.513v40.536l2.297 1.461c.396 12.154.396 24.308 1.216 36.462l-1.216 1.46v3.107c.908 0 1.815-.606 2.216-1.46 8.55-14.529 12.053-34.755 1.009-70.003l-2.009-11.563Z" fill="#47A248"/>
        </svg>
      ),
      color: '#47A248'
    },
  ...
  return (
    <section className="skills" id="skills" ref={sectionRef}>
      <div className="container">
        <h2 className="section-title fade-in">Professional Skills</h2>
        
        {/* Top Grid: Technology Stack (Left) + Competencies (Right) */}
        <div className="skills-top-grid fade-in">
          {/* Left Side - Technology Stack */}
          <div className="skills-intro-card">
            ...
            <p>
              ...
              Constantly learning and adapting to new tools and best practices in the industry.
            </p>
          </div>

          {/* Right Side - Competency Cards */}
          <div className="competencies-vertical">
            ...
            <div className="competency-card">
              ...
              <div className="competency-content">
                ...
                <p>Seamlessly connecting frontend and backend for complete web solutions</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Full-width Marquee Section with Inline SVG Icons */}
      <div className="marquee-fullwidth-section">
        <div className="marquee-fullwidth-container">
          <div className="marquee-fullwidth">
            <div className="marquee-fullwidth-content">
